	...
	<div id="wrapper">
		<div class="container">	
			<div class="row-fluid">
					...
					<a href="${ctx }/myCodeList.do"><span class="badge badge-success">내 코드보기</span></a>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
					...
					<tbody>
					  <c:choose>
							<c:when test="${Codes eq null || empty Codes }">
								<tr>
									<td style="text-align:center;">등록된 코드가 없습니다. </td>
								</tr>
							</c:when>
							<c:otherwise>
								...
								<fmt:formatDate var="newFormattedDate" value="${code.timeStamp }" pattern="yyyy-MM-dd HH:mm:ss "/>
									<tr>
										...
										<td style="text-align:center;">${code.likes }</td>
										<td style="text-align:center;">
											<a href="deleteCode.do?id=${code.id }"><span class="badge badge-important">DELETE</span></a>
										</td>
									</tr>
								</c:forEach>
							</c:otherwise>
